  ...
  return (
    <div className="max-w-4xl mx-auto pb-24">
            ...
            {recalls.map((recall, i) => (
              ...
              >
                <div className="flex items-start gap-3">
                  <div className={`p-2.5 rounded-xl shrink-0 ${recall.tipo === 'limpieza' ? 'bg-blue-100 text-blue-600 dark:bg-blue-900/20 dark:text-blue-400' : 'bg-purple-100 text-purple-600 dark:bg-purple-900/20 dark:text-purple-400'}`}>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <div className="bg-white dark:bg-surface px-4 py-2 rounded-full border border-gray-200 dark:border-white/5 shadow-sm text-sm font-bold text-dark flex items-center gap-2">
      ...
      <div className="space-y-4">
        {cargando ? (
          <div className="bg-white dark:bg-surface p-8 rounded-3xl border border-gray-100 dark:border-white/5 shadow-sm text-center font-medium text-muted">
          ...
          citasHoy.map((cita) => (
            <div 
              ...
              className="bg-white dark:bg-surface rounded-3xl shadow-sm border border-gray-100 dark:border-white/5 overflow-hidden flex flex-col transition-all hover:shadow-md hover:border-primary/30 dark:hover:border-primary/50 cursor-pointer"
            >
              ...
              <div className="p-4 md:p-5 flex justify-between items-center gap-4">
                ...
                <div className="flex flex-col items-end justify-center gap-2 shrink-0">
                  <span className="bg-surface dark:bg-background border border-gray-200 dark:border-white/5 text-xs font-bold px-4 py-2 rounded-full uppercase text-muted shadow-sm text-center w-full min-w-[120px]">
                    {cita.estado}
                  </span>
                  <button 
                    onClick={(e) => { e.stopPropagation(); toggleEdicionNota(cita.id_cita); }}
                    className="bg-orange-50 border border-orange-200 dark:bg-orange-900/20 dark:border-orange-800/50 hover:bg-orange-100 dark:hover:bg-orange-900/40 text-orange-600 dark:text-orange-400 text-xs font-bold px-4 py-2 rounded-full shadow-sm transition-colors flex items-center justify-center gap-1.5 w-full min-w-[120px]"
                  >
                    <Bell size={14} />
              ...
              {cita.recordatorio && !editandoNotas[cita.id_cita] && (
                <div className="bg-[#FFF8F3] dark:bg-orange-900/10 border-t border-orange-100 dark:border-orange-900/30 p-4 md:px-5 flex items-start gap-3">
                  ...
                  <p className="text-orange-800 dark:text-orange-300 font-medium text-sm leading-relaxed whitespace-pre-wrap">
                    {cita.recordatorio}
                  </p>
                </div>
              )}
              ...
              {editandoNotas[cita.id_cita] && (
                <div 
                  className="p-4 md:p-5 bg-surface/50 dark:bg-transparent border-t border-gray-100 dark:border-white/5 flex flex-col cursor-default"
                  onClick={(e) => e.stopPropagation()} 
                >
                  ...
                  <textarea 
                    ...
                    className="w-full flex-1 min-h-[80px] p-4 bg-white dark:bg-background border border-gray-200 dark:border-white/10 rounded-2xl focus:outline-none focus:border-orange-400 focus:ring-1 focus:ring-orange-400/50 text-dark resize-none transition-colors"
                  ></textarea>
          ...
          <div className="bg-white dark:bg-surface p-12 rounded-3xl border border-gray-100 dark:border-white/5 shadow-sm flex flex-col items-center justify-center text-center">
